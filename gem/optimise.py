...
def group_by(key_func, iterable):
    """Group entries in a acollection by their keys, generated by a prescribed
    key function
    :arg key_func: Function to generate keys from entries
    :arg iterable: An iterable collection
    :return: OrderedDict which maps keys to list of entries
    """
    groups = OrderedDict()
    for x in iterable:
        key = key_func(x)
